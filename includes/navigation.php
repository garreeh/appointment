...
<body>
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        <?php if (isset($_SESSION['user_id'])): ?>
                            <li><a href="/appointment/views/user/account_module.php">My Account</a></li>
                            <li><a href="/appointment/views/user/checkout_module.php">Checkout</a></li>
                            <li><a href="/appointment/views/user/order_module.php">Orders</a></li>
                            <li><a href="/appointment/views/user/received_module.php">Received</a></li>
                            <li><a href="/appointment/controllers/logout_process.php">Logout</a></li>
                        <?php else: ?>
    ...
    <div class="header">
        <div class="container">
            <a class="site-logo" href="/appointment/index.php">
                <img src="/appointment/assets/user/corporate/img/logos/logo-shop-red.png" alt="Metronic Shop UI">
            </a>
                ...
                <div class="top-cart-content-wrapper">
                    <div class="top-cart-content">
                        ...
                        <div class="text-right">
                            <a href="/appointment/views/user/checkout_module.php" class="btn btn-default">View Cart</a>
...
<script>
  $(document).ready(function() {
      ...
      function updateCart() {
          $.ajax({
              url: '/appointment/controllers/users/fetch_cart_process.php',
              method: 'GET',
              dataType: 'json',
      ...
      function deleteCartItem(productId) {
          $.ajax({
              url: '/appointment/controllers/users/delete_cart_process.php',
              method: 'POST',
    ...
    $('#submitCheckout').click(function(e) {
      ...
      $.ajax({
        type: 'POST',
        url: '/appointment/controllers/users/checkout_process.php',
        data: formData,
        contentType: false,
        processData: false,
        success: function(response) {
