...
$columns = array(
  array(
    ...
    'formatter' => function ($lab1, $row) {
      ...
      return '<a href="../admin/patient_solo_module.php?billing_id=' . $row['billing_id'] . '&user_id=' . $row['user_id'] . '">' . $row['billing_id'] . ' </a>';
    }
  ),
  ...
  array(
    ...
    'formatter' => function ($lab2, $row) {
      ...
      return '<a href="../admin/patient_solo_module.php?billing_id=' . $row['billing_id'] . '&user_id=' . $row['user_id'] . '">' . $row['user_fullname'] . ' </a>';
    }
  ),
  ...
  array(
    ...
    'formatter' => function ($lab4, $row) {
      // return $row['total'];
      return '<a href="../admin/patient_solo_module.php?billing_id=' . $row['billing_id'] . '&user_id=' . $row['user_id'] . '">' . $row['total'] . ' </a>';
    }
  ),
  ...
  array(
    ...
    'formatter' => function ($lab4, $row) {
      ...
      return '<a href="../admin/patient_solo_module.php?billing_id=' . $row['billing_id'] . '&user_id=' . $row['user_id'] . '">' . $row['payment_status'] . ' </a>';
    }
  ),
  ...
  array(
    ...
    'formatter' => function ($lab5, $row) {
      ...
      return '<a href="../admin/patient_solo_module.php?billing_id=' . $row['billing_id'] . '&user_id=' . $row['user_id'] . '">' . date('Y-m-d', strtotime($row['created_at'])) . ' </a>';
    }
  ),
