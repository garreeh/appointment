...
if (isset($_POST['unavailable_id'])) {
  ...
  if ($result) {
    ...
    ?>
  <div class="modal fade" id="fetchDataUnavailableModal" tabindex="-1" role="dialog" aria-labelledby="requestModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-l" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Update Supplier Details ID: <?php echo $row['unavailable_id']; ?></h5>
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <input type="date" class="form-control" id="unavailable_date" name="unavailable_date" 
                      value="<?php echo $row['unavailable_date']; ?>" 
                      required 
                      min="<?php echo date('Y-m-d'); ?>"> <!-- Inline disabling of past dates -->
              </div>
            </div>
